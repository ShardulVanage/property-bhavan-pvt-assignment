        ...
        <div className='mt-8 mx-4 md:mx-16 '>
            <div>
                ...
                <div className='md:w-2/3 lg:w-3/5 item-left pr-80 py-4'>
                    ...
                    <p className='mt-2 text-left py-4 px-72'>Poperty taxes are charged by local government entities, such as KMC, and are due by the owner of the property. The amount of KMC property tax that must be paid may vary. Thus, it depends on the location and a number of other criteria. KMC approved the new Unit Area Assessment (UAA) mechanism for calculating property taxes in March 2017</p>
            </div>
        </div>
    );
};
